namespace MassTransit.Futures.Endpoints
{
        ...
        where TCommand : class
    {
        ...
        public FutureCommand()
        {
            ...
            _endpoint = new InitializerCommandEndpoint<TRequest, TCommand>(_destinationAddressProvider, _pendingIdProvider, DefaultProvider);
        }

        public AsyncFutureMessageFactory<TRequest, TCommand> Factory
        {
            set => _endpoint = new FactoryCommandEndpoint<TRequest, TCommand>(_destinationAddressProvider, _pendingIdProvider, value);
        }

        public InitializerValueProvider<TRequest> Initializer
        {
            set => _endpoint = new InitializerCommandEndpoint<TRequest, TCommand>(_destinationAddressProvider, _pendingIdProvider, value);
        }
        ...
        public PendingIdProvider<TCommand> PendingIdProvider
        {
            set
            {
                _pendingIdProvider = value;
                _endpoint.PendingIdProvider = value;
            }
        }
